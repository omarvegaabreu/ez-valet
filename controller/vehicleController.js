...
module.exports = {
  ...
  create: function(req, res) {
    ...
    // pullEmails();
    const mailOptions = {
      from: '"EZ Valet" <omarvegaezvalet@gmail.com>',
      to: ["omarvegaezvalet@gmail.com"],
      ...
      text:
        ...
        req.body.customerId +
        ") " +
        "has been succussfully registered. " +
        "Registered Phone is " +
        req.body.pocphone +
        " ."
    };
    transport.sendMail(mailOptions, function(error, info) {
      ...
      client.messages
        .create({
          body:
            "Thank you for parking your vehicle with us. Your e-ticket # is " +
            req.body.customerId +
            '. You will need this e-ticket # when you are ready to pickup your vehicle back. You can simply reply "Ready" to this message and we will have your car ready for pickup within 5 minutes.',
  ...
  update: function(req, res) {
    ...
    db.Vehicle.findOneAndUpdate({ _id: new ObjectId(req.params.id) }, req.body)
      .then(dbModel => {
  ...
  remove: function(req, res) {
    db.Vehicle.findById({ _id: req.params.id })
      ...
      { $match: { createdAt: { $gt: sevenDaysAgo } } },
      {
        $group: {
          _id: {
            ...
            day: {
              $dayOfMonth: { date: "$createdAt", timezone: "America/New_York" }
            }
          },
          count: { $sum: 1 }
        }
